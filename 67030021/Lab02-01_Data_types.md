...
3.1 คุณสังเกตเห็นความแตกต่างของความแม่นยำระหว่าง float และ double อย่างไร? 
    ค่า float มีความแม่นยำประมาณ 6–7 หลัก ส่วน double ได้ถึง ~15 หลัก ทศนิยมเกินจากนี้จะถูกตัดทิ้งหรือปัด
3.2 สถานการณ์ใดที่คุณควรเลือกใช้ double แทน float?
    ใช้ double เมื่อต้องการ ความแม่นยำสูง เช่น งานทางวิทยาศาสตร์ พิกัด GPS หรือการวิเคราะห์ข้อมูลที่ละเอียด
...
5.1 true และ false ถูกแสดงผลเป็นค่าใดบน Serial Monitor?
    true แสดงเป็น 1, false แสดงเป็น 0 บน Serial Monitor เพราะเบื้องหลัง bool เป็นข้อมูลแบบบิต
...
6.2 ชนิดข้อมูลใดที่ต้องใช้หากต้องการเก็บค่าจำนวนเต็มบวกที่ใหญ่ที่สุด?
    ใช้ unsigned long long เพราะสามารถเก็บค่าบวกได้สูงสุดประมาณ 2^64 - 1
...
- เมื่อ myByte ถูกกำหนดให้เป็น 256 ผลลัพธ์ที่ได้คืออะไร และเพราะเหตุใด?
  จะได้ ค่า = 0 เพราะ byte เก็บได้แค่ 0–255 (8 บิต) พอเกินจะวนกลับไปที่ 0 (Overflow)
