...
1.1  ทำไม 10 / 3.0 (เมื่อตัวหารเป็น float หรือ double) ถึงได้ผลลัพธ์เป็นทศนิยม แต่เมื่อตัวหารถูกแปลงเป็น int แล้วผลลัพธ์เป็นจำนวนเต็ม?
    ...
    เพราะ 3.0 เป็นชนิด float หรือ double ทำให้ผลลัพธ์กลายเป็น ทศนิยม (ถูกแปลงอัตโนมัติให้ตรงกับชนิดที่ใหญ่กว่า)
    แต่เมื่อ 3.0 ถูกแปลงเป็น int จะเหลือแค่เลข 3 → ทำให้เป็นการ หารจำนวนเต็ม และผลลัพธ์ก็จะเป็น จำนวนเต็ม โดยตัดทศนิยมทิ้ง
...
ควรทำ Type Casting เมื่อ
-ต้องการควบคุมชนิดของผลลัพธ์ เช่น ทำให้ผลลัพธ์เป็นทศนิยม
-ต้องการแปลงค่าทศนิยมเป็นจำนวนเต็ม เพื่อตัดเศษออก
-ต้องการแสดงเลข ASCII ของตัวอักษร
-ต้องแปลงชนิดข้อมูลให้ ตรงกับที่ฟังก์ชันต้องการ