...
__ตอบ__ ตรงตามหลักการทางคณิตศาสตร์ ค่าที่ใส่ (100) อยู่ภายในช่วงที่ตัวแปร int สามารถเก็บได้โดยไม่มีการเปลี่ยนแปลงหรือเสียความแม่นยำ ตัวเลข 100 เป็นค่าคงที่ (constant) ที่ถูกเก็บในตัวแปรชนิด int


2.2  สังเกตผลจากการรันโคิดในส่วน 2.2 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด

__ตอบ__ ตรงตามหลักการทางคณิตศาสตร์ ค่าที่กำหนด (2147483647) อยู่ภายในช่วงที่ int แบบ 32-bit สามารถเก็บได้พอดี


2.3  สังเกตผลจากการรันโคิดในส่วน 2.3 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด

__ตอบ__ ไม่ตรงตามหลักการทางคณิตศาสตร์ผลลัพธ์ที่ควรได้คือ 2147483648 แต่กลับได้ -2147483648 ซึ่งเป็น ค่าต่ำสุด ของ int แทน เกิดปรากฏการณ์ที่เรียกว่า Integer Overflow


2.4  สังเกตผลจากการรันโคิดในส่วน 2.4 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด

__ตอบ__ ตรงตามหลักการทางคณิตศาสตร์ -2147483648 อยู่ภายในขอบเขตของชนิดข้อมูล int (signed 32-bit) ตัวเลขนี้คือ ค่าที่ต่ำสุดพอดี ที่ระบบสามารถแสดงได้โดยไม่เพี้ยน


2.5  สังเกตผลจากการรันโคิดในส่วน 2.5 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด

__ตอบ__ ไม่ตรงตามหลักการทางคณิตศาสตร์ เกิด Integer Underflow เมื่อค่าลดต่ำกว่าขอบเขตที่ int สามารถเก็บได้ (-2147483648) → บิตจะ วนกลับ ไปยังค่าบวกสูงสุดแทน (2147483647)
...
__ตอบ__ ชนิดข้อมูล float ให้ความแม่นยำได้เพียงประมาณ 6-7 ตำแหน่งทศนิยมเท่านั้น ดังนั้นค่าทศนิยมหลังจากตำแหน่งที่ 7 จะเริ่มคลาดเคลื่อน 
ในขณะที่ double ให้ความแม่นยำสูงกว่ามาก สามารถเก็บค่าทศนิยมได้ประมาณ 15-16 ตำแหน่ง ทำให้ค่าที่แสดงออกมาถูกต้องใกล้เคียงกับค่าจริงมากกว่า

3.2 สถานการณ์ใดที่คุณควรเลือกใช้ double แทน float?

__ตอบ__ float ใช้เมื่อ ความแม่นยำไม่สำคัญมาก, ต้องการประหยัดหน่วยความจำ, คำนวณเลขทั่วไป เช่น อุณหภูมิ, ความเร็ว
double ใช้เมื่อ 	ต้องการความแม่นยำสูง, จำลองวิทยาศาสตร์, พิกัด GPS, คำนวณฟิสิกส์,	ยอมใช้ RAM เพิ่มขึ้นเพื่อความแม่นยำ
...
__ตอบ__ คือมาตรฐานรหัสที่ใช้แทนตัวอักษร, ตัวเลข, สัญลักษณ์ และคำสั่งควบคุมด้วยค่าตัวเลข (จำนวนเต็ม) ตั้งแต่ 0 ถึง 127 ทุกตัวอักษรหรือสัญลักษณ์ที่เรามองเห็นในคอมพิวเตอร์ จะถูกแทนด้วยตัวเลข ASCII ที่ตรงกัน เช่น 'A' มีค่า ASCII = 65, 'z' = 122

4.2 ถ้าอยากทราบความสัมพันธ์ระหว่างตัวเลขกับอักขระทั้งหมด สามารถหาได้จากเอกสารใด หรือแหล่งอ้างอิงใด

__ตอบ__ แหล่งอ้างอิง เว็บไซต์ https://www.asciitable.com/

4.3 จากข้อ 4.2 นักเขียนโปรแกรมสามารถกำหนดขึ้นเองได้ หรือมีเอกสารใดกำกับอยู่

__ตอบ__ ASCII เป็นมาตรฐานตายตัวที่ไม่เปลี่ยนแปลง มีมาตรฐานใหม่ ๆ ที่พัฒนาขึ้นเพื่อรองรับอักขระเพิ่ม เช่น Unicode นักพัฒนาสามารถใช้หรือขยายชุดรหัสเหล่านี้ได้ แต่ควรอิงตามมาตรฐานที่เป็นที่ยอมรับ
...
__ตอบ__ บน Serial Monitor true จะแสดงผลเป็น 1 , false จะแสดงผลเป็น 0
...
__ตอบ__ บน ESP32, long และ int มีขนาดและขอบเขต เท่ากัน
int	4 ไบต์	-2,147,483,648 ถึง 2,147,483,647
long	4 ไบต์	-2,147,483,648 ถึง 2,147,483,647

6.2 ชนิดข้อมูลใดที่ต้องใช้หากต้องการเก็บค่าจำนวนเต็มบวกที่ใหญ่ที่สุด?

__ตอบ__ ใช้ uint64_t (unsigned 64-bit integer) uint64_t	8 ไบต์	0 ถึง 18,446,744,073,709,551,615
...
- เมื่อ myByte ถูกกำหนดให้เป็น 256 ผลลัพธ์ที่ได้คืออะไร และเพราะเหตุใด?
  ...
  __ตอบ__ เมื่อกำหนด myByte = 256; จะเกิดการล้นค่า
  จึงได้ผลลัพธ์เป็น 0 เพราะบิตที่เก็บได้ใน byte มีแค่ 8 บิต และ 256 = 0 ในขอบเขตนี้
