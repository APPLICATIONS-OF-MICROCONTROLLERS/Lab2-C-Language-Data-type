...
ตอบ ตรงตามหลักการทางคณิตศาสตร์ ค่าที่ใส่ (100) อยู่ภายในช่วงที่ตัวแปร int สามารถเก็บได้โดยไม่มีการเปลี่ยนแปลงหรือเสียความแม่นยำ ตัวเลข 100 เป็นค่าคงที่ (constant) ที่ถูกเก็บในตัวแปรชนิด int

2.2  สังเกตผลจากการรันโคิดในส่วน 2.2 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด
ตอบ ตรงตามหลักการทางคณิตศาสตร์ ค่าที่กำหนด (2147483647) อยู่ภายในช่วงที่ int แบบ 32-bit สามารถเก็บได้พอดี

2.3  สังเกตผลจากการรันโคิดในส่วน 2.3 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด
ตอบ ไม่ตรงตามหลักการทางคณิตศาสตร์ผลลัพธ์ที่ควรได้คือ 2147483648 แต่กลับได้ -2147483648 ซึ่งเป็น ค่าต่ำสุด ของ int แทน เกิดปรากฏการณ์ที่เรียกว่า Integer Overflow

2.4  สังเกตผลจากการรันโคิดในส่วน 2.4 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด
ตอบ ตรงตามหลักการทางคณิตศาสตร์ -2147483648 อยู่ภายในขอบเขตของชนิดข้อมูล int (signed 32-bit) ตัวเลขนี้คือ ค่าที่ต่ำสุดพอดี ที่ระบบสามารถแสดงได้โดยไม่เพี้ยน

2.5  สังเกตผลจากการรันโคิดในส่วน 2.5 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด
ตอบ ไม่ตรงตามหลักการทางคณิตศาสตร์ เกิด Integer Underflow เมื่อค่าลดต่ำกว่าขอบเขตที่ int สามารถเก็บได้ (-2147483648) → บิตจะ วนกลับ ไปยังค่าบวกสูงสุดแทน (2147483647)
