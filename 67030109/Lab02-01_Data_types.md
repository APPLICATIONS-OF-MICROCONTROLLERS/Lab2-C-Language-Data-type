...
ตอบ ชนิดข้อมูล float ให้ความแม่นยำได้เพียงประมาณ 6-7 ตำแหน่งทศนิยมเท่านั้น ดังนั้นค่าทศนิยมหลังจากตำแหน่งที่ 7 จะเริ่มคลาดเคลื่อน 
...
ตอบ float ใช้เมื่อ ความแม่นยำไม่สำคัญมาก, ต้องการประหยัดหน่วยความจำ, คำนวณเลขทั่วไป เช่น อุณหภูมิ, ความเร็ว
...
ตอบ คือมาตรฐานรหัสที่ใช้แทนตัวอักษร, ตัวเลข, สัญลักษณ์ และคำสั่งควบคุมด้วยค่าตัวเลข (จำนวนเต็ม) ตั้งแต่ 0 ถึง 127 ทุกตัวอักษรหรือสัญลักษณ์ที่เรามองเห็นในคอมพิวเตอร์ จะถูกแทนด้วยตัวเลข ASCII ที่ตรงกัน เช่น 'A' มีค่า ASCII = 65, 'z' = 122

4.2 ถ้าอยากทราบความสัมพันธ์ระหว่างตัวเลขกับอักขระทั้งหมด สามารถหาได้จากเอกสารใด หรือแหล่งอ้างอิงใด
ตอบ แหล่งอ้างอิง เว็บไซต์ https://www.asciitable.com/

4.3 จากข้อ 4.2 นักเขียนโปรแกรมสามารถกำหนดขึ้นเองได้ หรือมีเอกสารใดกำกับอยู่
ตอบ ASCII เป็นมาตรฐานตายตัวที่ไม่เปลี่ยนแปลง มีมาตรฐานใหม่ ๆ ที่พัฒนาขึ้นเพื่อรองรับอักขระเพิ่ม เช่น Unicode นักพัฒนาสามารถใช้หรือขยายชุดรหัสเหล่านี้ได้ แต่ควรอิงตามมาตรฐานที่เป็นที่ยอมรับ
...
ตอบ บน Serial Monitor true จะแสดงผลเป็น 1 , false จะแสดงผลเป็น 0
...
ตอบ บน ESP32, long และ int มีขนาดและขอบเขต เท่ากัน
...
ตอบ ใช้ uint64_t (unsigned 64-bit integer) uint64_t	8 ไบต์	0 ถึง 18,446,744,073,709,551,615
...
- เมื่อ myByte ถูกกำหนดให้เป็น 256 ผลลัพธ์ที่ได้คืออะไร และเพราะเหตุใด?
  ตอบ เมื่อกำหนด myByte = 256; จะเกิดการล้นค่า
