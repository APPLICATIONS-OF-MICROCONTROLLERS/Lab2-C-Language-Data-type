...
__ตอบ__  1.เมื่อคำนวณระหว่างชนิดข้อมูลต่างกัน  2.เมื่อต้องการควบคุมผลลัพธ์ของการแปลงข้อมูล  3.เมื่อต้องการใช้ข้อมูลในรูปแบบอื่นชั่วคราว  4.เมื่อต้องการแปลงค่าตัวเลขให้พอดีกับชนิดข้อมูลปลายทาง  5.เมื่อต้องการบังคับลำดับการคำนวณ  6.เมื่อต้องใช้ชนิดข้อมูลเฉพาะในบางฟังก์ชัน/ไลบรารี
