...
__ตอบ__ int บน ESP32 ใช้ขนาด 4 ไบต์ (32 บิต)

1.2 จากผลลัพธ์ นักศึกษาสังเกตเห็นอะไรเมื่อค่าเกินขอบเขตของ int บน ESP32? 

__ตอบ__ เกิด Overflow ผลลัพธ์ที่ได้กลายเป็น: -2147483648 (ค่าต่ำสุดของ int)
...
__ตอบ__ float	4 ไบต์ , double	8 ไบต์

- นักศึกษาสังเกตเห็นความแตกต่างของความแม่นยำระหว่าง float และ double อย่างไร? สถานการณ์ใดที่คุณควรเลือกใช้ double แทน float?
  
__ตอบ__ float จะมีความแม่นยำน้อยกว่า และ double จะให้ความแม่นยำที่สูงกว่า สถานการณ์ใดที่คุณควรเลือกใช้ double แทน float คือ การคำนวณทางการเงิน ต้องการความแม่นยำสูงเพื่อหลีกเลี่ยงความผิดพลาดจากทศนิยม
...
__ตอบ__ ชนิดข้อมูล char ใช้ 1 ไบต์ (8 บิต) อักขระทุกตัว จะมี รหัสตัวเลขประจำ ที่เรียกว่า ASCII (American Standard Code for Information Interchange)
...
__ตอบ__ ขนาดของ bool 1 bytes แสดงผลเป็นค่าใดบน Serial Monitor myBool = true ผลลัพธ์: 1 , myBool = false ผลลัพธ์: 0
...
- ชนิดข้อมูลจำนวนเต็มแต่ละชนิด (long, long long, unsigned int, unsigned long, unsigned long long) ใช้กี่ไบต์บน ESP32?
 ...
 __ตอบ__  long	4 ไบต์	32 บิต , long long	8 ไบต์	64 บิต , unsigned int	4 ไบต์		32 บิต , unsigned long	4 ไบต์	32 บิต , unsigned long long	8 ไบต์		64 บิต

- บน ESP32, long มีขอบเขตเท่ากับ int หรือไม่? ชนิดข้อมูลใดที่คุณจะใช้หากต้องการเก็บค่าจำนวนเต็มบวกที่ใหญ่ที่สุด?

__ตอบ__ long มีขอบเขตเท่ากับ int 32 บิต (4 ไบต์) ถ้าต้องการเก็บ ค่าจำนวนเต็มบวกที่ใหญ่ที่สุดใช้ unsigned long long
...
__ตอบ__ byte ใช้ขนาด 1 ไบต์ (8 บิต) ถ้า myByte = 256 ผลลัพธ์: 0
...
__ตอบ__ เมื่อมีการหาร int กับ float หรือ double (เช่น 10 / 3.0) ตัวแปร int จะถูก แปลงแบบอัตโนมัติ (implicit type conversion) เป็นชนิดทศนิยม (float หรือ double) และ (int)3.0 จะถูกแปลงเป็นจำนวนเต็ม 3 (ตัดทศนิยมทิ้ง)ดังนั้นการหารจึงเป็น int / int ผลลัพธ์เป็นจำนวนเต็ม
...
__ตอบ__  สถานการณ์ที่ควรใช้ Type Casting เพื่อป้องกันการสูญเสียข้อมูลในการหารและ เมื่อใช้กับชนิดข้อมูลขนาดต่างกัน ตัวอย่างเมื่อ int ถูกใช้ร่วมกับ long หรือ double
