...
## สรุปผลการทดลอง
  จากการทดลองที่ได้ทำไป ผมได้เรียนรู้เกี่ยวกับชนิดข้อมูลต่างๆ ที่ใช้บนบอร์ด ESP32 เช่น int, float, double, char, bool, long, unsigned และ byte โดยแต่ละชนิดจะมีขนาดและขอบเขตการเก็บค่าที่ต่างกัน
