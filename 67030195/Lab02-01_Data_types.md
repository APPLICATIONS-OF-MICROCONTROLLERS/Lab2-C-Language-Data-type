...
3.2 สถานการณ์ใดที่คุณควรเลือกใช้ double แทน float?
    ...
    ตอบ : ควรเลือกใช้ double เมื่อต้องการความแม่นยำที่สูง เช่น การคำนวนเงิน การทดลองวิทยาศาสตร์ที่ต้องการความแม่นยำสูง ๆ  และควรเลือกใช้ float ในกรณีที่ต้องการความแม่นยำของทศนิยมไม่มาก เช่น การแสดงตัวเลขเบื้องต้น
