...
4.2 ถ้าอยากทราบความสัมพันธ์ระหว่างตัวเลขกับอักขระทั้งหมด สามารถหาได้จากเอกสารใด หรือแหล่งอ้างอิงใด
    ...
    1. ตาราง ASCII (ASCII Table):คือแหล่งอ้างอิงหลักและง่ายที่สุดที่จะแสดงการจับคู่ระหว่างอักขระกับค่าตัวเลข ASCII (ทั้งในรูปเลขฐานสิบ, ฐานสอง, ฐานแปด และฐานสิบหก) สามารถค้นหาโดยใช้คำว่า "ASCII table" ใน Google Images หรือเว็บไซต์ที่เกี่ยวข้องกับวิทยาการคอมพิวเตอร์ 
