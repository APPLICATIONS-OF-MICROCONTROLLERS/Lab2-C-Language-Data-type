...
1.1  ทำไม 10 / 3.0 (เมื่อตัวหารเป็น float หรือ double) ถึงได้ผลลัพธ์เป็นทศนิยม แต่เมื่อตัวหารถูกแปลงเป็น int แล้วผลลัพธ์เป็นจำนวนเต็ม?
    ...
    ตอบ : เมื่อ 10 / 3.0 (เมื่อตัวหารเป็น float หรือ double) ได้ผลลัพธ์เป็นทศนิยม เพราะ 10 เป็น int ถูกหารด้วยตัวหารที่เป็น float (3.0f) หรือ double (3.0) 
    ระบบจะทำการแปลงตัวถูกหารให้เป็นชนิดข้อมูลเดียวกันกับตัวหาร (implicit type conversion) ก่อนที่จะทำการหาร 
    เนื่องจาก float และ double เป็นชนิดข้อมูลที่ใช้เก็บเลขทศนิยม การดำเนินการหารจึงเป็นการหารแบบทศนิยม ผลลัพธ์ที่ได้จึงเป็นค่าทศนิยมที่แม่นยำตามชนิดข้อมูลนั้นๆ 
...
- ดำเนินการจำลองตามวิธีที่ได้ทดลองมาแล้ว
- ผลลัพธ์ที่ได้
  ![image](https://github.com/user-attachments/assets/98aa6883-5b76-4268-a064-45bf4cb1502f)
