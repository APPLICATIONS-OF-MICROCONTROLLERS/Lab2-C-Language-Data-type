...
เมื่อค่าลดลงเกินขีดจำกัดต่ำสุด (-2,147,483,648) ค่าจะ "วนกลับ" (wrap around) ไปเป็นค่าบวกที่มากที่สุดของ int คือ 2,147,483,647 ซึ่งเป็นค่าสูงสุดที่ int เก็บได้ 
