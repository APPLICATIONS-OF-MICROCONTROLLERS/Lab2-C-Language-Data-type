...
1.2 จากผลลัพธ์ นักศึกษาสังเกตเห็นอะไรเมื่อค่าเกินขอบเขตของ int บน ESP32? 
  ...
  ตอบ : สังเกตเห็นว่า 
เมื่อค่าเพิ่มขึ้นเกินขีดจำกัดสูงสุด (2,147,483,647) ค่าจะ "วนกลับ" (wrap around) ไปเป็นค่าติดลบที่น้อยที่สุดของ int คือ -2,147,483,648 ซึ่งเป็นค่าต่ำสุดที่ int เก็บได้ 
ข้อสังเกต: เมื่อค่าลดลงเกินขีดจำกัดต่ำสุด (-2,147,483,648) ค่าจะ "วนกลับ" (wrap around) ไปเป็นค่าบวกที่มากที่สุดของ int คือ 2,147,483,647 ซึ่งเป็นค่าสูงสุดที่ int เก็บได้ 
