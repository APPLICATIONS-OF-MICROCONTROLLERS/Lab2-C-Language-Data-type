...
ตอบ ตรงตามหลักการ เนื่องด้วย ประกาศตัวแปร myInteger = 100 แล้ว เมื่อแสดงค่าออกมาเป็น 100 จึงถูกตามหลักคณิตศาสตร์

2.2  สังเกตผลจากการรันโคิดในส่วน 2.2 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด

ตอบ ตรงตามหลักการ เนื่องด้วย ประกาศตัวแปร myInteger = 2147483647 แล้ว เมื่อแสดงค่าออกมาเป็น 2147483647 จึงถูกตามหลักคณิตศาสตร์

2.3  สังเกตผลจากการรันโคิดในส่วน 2.3 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด

ตอบ ไม่ตรงเนื่องจาก เมื่อเอา 2147483647 + 1 เข้าไปได้ ค่าลบ โดยเรียกสิ่งนี้ว่า Overflow เนื่องจาก ค่า int ที่สูงสุดของบวกคือ 2147483647 พอบวกเข้าไปก็เลยวนกลับมาช่วงลบของ int แทน

2.4  สังเกตผลจากการรันโคิดในส่วน 2.4 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด

ตอบ ตรงตามหลักการ เนื่องด้วย ประกาศตัวแปร myInteger = -2147483648 แล้ว เมื่อแสดงค่าออกมาเป็น - 2147483648 จึงถูกตามหลักคณิตศาสตร์

2.5  สังเกตผลจากการรันโคิดในส่วน 2.5 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด

ตอบ ไม่ตรงเนื่องจาก เมื่อเอา -2147483648 - 1 เข้าไปได้ ค่าลบ โดยเรียกสิ่งนี้ว่า Overflow เนื่องจาก ค่า int ที่ต่ำสุดของลบคือ -2147483648 พอลบเข้าไปก็เลยวนกลับมาช่วงบวกของ int แทน
...
ตอบ  float แสดงค่า Pi เลขท้าย ๆ ผิด แค่ double มีความแม่นยำที่่มากกว่า 

3.2 สถานการณ์ใดที่คุณควรเลือกใช้ double แทน float?
ตอบ double ใช้ในงานที่ต้องการความแม่นยำมาก ๆ แต่ float ใช้ก็ต่อเมื่อใช้งานทั่ว ๆ ไป
...
ตอบ แต่ละอักขระมีค่าตัวเลขเฉพาะ - ทุกอักขระจะถูกแทนด้วยตัวเลข 0-127 ใน ASCII แบบมาตรฐาน
การจัดเรียงแบบลำดับ - อักขระถูกจัดเรียงอย่างมีระบบ:

ตัวเลข 0-9: ASCII 48-57
ตัวอักษรพิมพ์ใหญ่ A-Z: ASCII 65-90
ตัวอักษรพิมพ์เล็ก a-z: ASCII 97-122

4.2 ถ้าอยากทราบความสัมพันธ์ระหว่างตัวเลขกับอักขระทั้งหมด สามารถหาได้จากเอกสารใด หรือแหล่งอ้างอิงใด
ตอบ https://payat-jira.medium.com/ascii-code-%E0%B8%84%E0%B8%B7%E0%B8%AD%E0%B8%AD%E0%B8%B0%E0%B9%84%E0%B8%A3-80550104836b

4.3 จากข้อ 4.2 นักเขียนโปรแกรมสามารถกำหนดขึ้นเองได้ หรือมีเอกสารใดกำกับอยู่
ตอบ เป็นมาตรฐานสากล - ASCII เป็นมาตรฐานที่กำหนดโดยองค์กรมาตรฐานสากล ไม่ใช่สิ่งที่นักเขียนโปรแกรมสามารถเปลี่ยนแปลงได้
ความเข้ากันได้ - หากแต่ละคนกำหนดเอง จะทำให้ข้อมูลไม่สามารถแลกเปลี่ยนกันได้
Hardware และ Software dependency - ระบบคอมพิวเตอร์ทั้งหมดใช้มาตรฐานเดียวกัน
...
- ตอบ 0 เพราะ ค่าเกิรขอบเขต 0 - 255
