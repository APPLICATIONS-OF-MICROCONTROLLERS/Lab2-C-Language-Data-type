...
ตอบ (int)3.0 บังคับแปลง 3.0 เป็น 3 (int)
การคำนวณ: 10 / 3 (int / int)
ไม่มี Type Promotion เพราะทั้งสองเป็น int
การหาร int แบบจำนวนเต็ม: 10 ÷ 3 = 3 (ทศนิยมถูกตัดทิ้ง)
ผลลัพธ์: 3 (จำนวนเต็ม)
...
- ตอบ 1. การหลีกเลี่ยงการหารแบบจำนวนเต็ม
- 2. การคำนวณเปอร์เซ็นต์และอัตราส่วน
  3. การทำงานกับ ASCII และอักขระ เป็นต้น
