...
ตอบ  Overflow: ค่าจะหมุนกลับไปที่ค่าต่ำสุด 
Underflow: ค่าจะหมุนไปที่ค่าสูงสุด
...
- ตอบ float: 4 ไบต์ (32 bits) - Single Precision
double: 8 ไบต์ (64 bits) - Double Precision

- นักศึกษาสังเกตเห็นความแตกต่างของความแม่นยำระหว่าง float และ double อย่างไร? สถานการณ์ใดที่คุณควรเลือกใช้ double แทน float?

- ตอบ Float: ความแม่นยำประมาณ 6-7 หลักนำหน้า เลือกใช้เมื่อเป็นงานทั่วไปไม่ได้ใช้ความแม่นยำสู.
Double: ความแม่นยำประมาณ 15-16 หลักนำหน้า ต้องการใช้ความแม่นยำสูง
...
- ตอบ: 1 ไบต์ (8 bits)  char เก็บข้อมูลเป็นตัวเลข แต่แสดงผลเป็นอักขระ
ASCII  เป็นมาตรฐานการเข้ารหัสอักขระ
ช่วงค่า: 0-127 (Standard ASCII) หรือ 0-255 (Extended ASCII)
...
- ตอบ 1 ไบต์ (8 บิต) T แสดงเลข 1 และ F แสดงเลข 0
...
ตอบ ใช้ 1 ไบต์ (8 บิต) เป็น 0 เพราะ ค่าเกินขอบเขต (0-255)
...
ตอบ ทั้งสองตัวเป็น int
คำนวณ: 10 / 3 = 3 (หารแบบจำนวนเต็ม)
ผลลัพธ์: จำนวนเต็ม (ตัดทศนิยมทิ้ง)
...
ตอบ 1. การแปลงค่าจาก Sensor และ ADC
2. การแสดงผลบนหน้าจอ float temperature = 27.856;
int displayTemp = (int)(temperature + 0.5);  // ปัดเศษ
// แสดงเป็น "28°C" แทน "27.856°C"
เป็นต้น
