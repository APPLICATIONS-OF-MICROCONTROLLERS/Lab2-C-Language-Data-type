...
- ดำเนินการจำลองตามวิธีที่ได้ทดลองมาแล้ว
![image](https://github.com/user-attachments/assets/49536f5c-c832-42a3-8ca4-b64fa8838e76)


__คำถาม__ 

6.1 บน ESP32, long มีขอบเขตเท่ากับ int หรือไม่? 
- สำหรับ ESP32 int และ long มีขอบเขตการเก็บค่าเท่ากันครับ

6.2 ชนิดข้อมูลใดที่ต้องใช้หากต้องการเก็บค่าจำนวนเต็มบวกที่ใหญ่ที่สุด?
- คุณควรใช้ long ทำให้ตัวแปรนั้นเก็บได้เฉพาะค่าบวกเท่านั้น และใช้ทุกบิตที่มีในการเก็บค่าตัวเลข 
...
- ดำเนินการจำลองตามวิธีที่ได้ทดลองมาแล้ว
![image](https://github.com/user-attachments/assets/a50fed54-a4b0-4b4b-b371-57f45e687d74)

__คำถาม__ 

เมื่อ myByte ถูกกำหนดให้เป็น 256 ผลลัพธ์ที่ได้คืออะไร และเพราะเหตุใด?
- ผลลลัพธ์จะเท่ากับ 0
- เพราะว่า เป็นข้อมูลแบบ 8-bit integer ซึ่งสามารถเก็บค่าได้ตั้งแต่ 0 ถึง 255 เท่านั้น เมื่อมีการกำหนดค่า 256 ซึ่งเกินขีดจำกัดสูงสุด(overflow)
