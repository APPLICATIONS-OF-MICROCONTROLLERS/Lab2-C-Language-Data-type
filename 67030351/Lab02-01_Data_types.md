...
- 
![image](https://github.com/user-attachments/assets/dd8dc513-79da-4a28-a9f6-838fb4a26434)


__คำถาม__ 

3.1 คุณสังเกตเห็นความแตกต่างของความแม่นยำระหว่าง float และ double อย่างไร? 
- double มีความละเอียดของตำแหน่งของทศนิยม มาากว่า float

3.2 สถานการณ์ใดที่คุณควรเลือกใช้ double แทน float?
- เมื่อคุณต้องการความแม่นยำที่สูงกว่าในการคำนวณตัวเลขทศนิยม
...
![image](https://github.com/user-attachments/assets/c06cb0d8-33f5-4a33-a225-223ab86e0c14)

__คำถาม__ 

4.1 ค่าตัวเลข (ASCII value) มีความสัมพันธ์กับอักขระอย่างไร?
- ตัวกลางในการแทนอักขระที่มนุษย์อ่านเข้าใจ ให้กลายเป็นรูปแบบตัวเลขที่คอมพิวเตอร์เข้าใจและประมวลผลได้

4.2 ถ้าอยากทราบความสัมพันธ์ระหว่างตัวเลขกับอักขระทั้งหมด สามารถหาได้จากเอกสารใด หรือแหล่งอ้างอิงใด
- ดูจากตาราง ASCII
-  ![image](https://github.com/user-attachments/assets/7b31900a-2c51-4523-9aab-fe73d208d252)

4.3 จากข้อ 4.2 นักเขียนโปรแกรมสามารถกำหนดขึ้นเองได้ หรือมีเอกสารใดกำกับอยู่
-  ไม่สามารถกำหนดค่าตัวเลข ASCII เนื่องจากมีมาตราฐานกำหนดอยู่
