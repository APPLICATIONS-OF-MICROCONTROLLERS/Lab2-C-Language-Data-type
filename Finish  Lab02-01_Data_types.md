...
2.1  สังเกตผลจากการรันโคิดในส่วน 2.1 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด
      ...
      ตรงตามหลักการทางคณิตศาสตร์ เพราะ 100 อยู่ในช่วงที่ int ที่เก็บค่าได้ตั้งแต่ -2,147,483,648 ถึง 2,147,483,647 บน ESP32

2.2  สังเกตผลจากการรันโคิดในส่วน 2.2 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด
      
      ตรงตามหลักการทางคณิตศาสตร์ เพราะ 2,147,483,647 คือค่าสูงสุดของ int

2.3  สังเกตผลจากการรันโคิดในส่วน 2.3 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด

      ไม่ตรงตามหลักการทางคณิตศาสตร์ เพราะ เกิด Overflow เมื่อมีค่ามากกว่า 2,147,483,647 จะวนกลับไปเป็นค่าติดลบ

2.4  สังเกตผลจากการรันโคิดในส่วน 2.4 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด

      ตรงตามหลักการ เพราะ -2,147,483,648 คือค่าต่ำสุดของ int ที่เก็บค่าได้ 

2.5  สังเกตผลจากการรันโคิดในส่วน 2.5 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด

    ไม่ตรงตามหลักการทางคณิตศาสตร์ เพราะ เกิด Underflow เมื่อมีค่าต่ำกว่า -2,147,483,647 จะวนกลับไปเป็นค่าบวก
...
3.1 คุณสังเกตเห็นความแตกต่างของความแม่นยำระหว่าง float และ double อย่างไร?
    ...
    float แสดงทศนิยมได้แค่ประมาณ 8 ตำแหน่ง และ double แสดงได้ถึง 15 ตำแหน่ง 

3.2 สถานการณ์ใดที่คุณควรเลือกใช้ double แทน float?

    การคำนวณวิศวกรรม, ฟิสิกส์, คณิตศาสตร์เชิงตัวเลข
...
``` c
บน Serial Monitor true จะถูกแสดงเป็น 1 และ false จะถูกแสดงเป็น 0
```
...
``` c
    บน ESP32 long และ int มีขอบเขต เท่ากัน 
```
6.2 ชนิดข้อมูลใดที่ต้องใช้หากต้องการเก็บค่าจำนวนเต็มบวกที่ใหญ่ที่สุด?
``` c
    ใช้ unsigned long long (64-bit ไม่มีเครื่องหมาย) เก็บได้สูงสุด ≈ 18.4 ควินทิลเลียน (2^64 - 1)
```
...
``` c 
  ผลลัพธ์ที่ได้คือ 0 เพราะ เกิด Overflow เนื่องจาก byte เก็บได้แค่ 0–255 เท่านั้น
```
