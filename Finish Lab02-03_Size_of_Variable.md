...
``` c
เกินขอบเขตของ int จะเกิด overflow หริอ underflow ทำให้ค่ากลายเป็นลบ หรือ บวก
```
...
- float และ double บน ESP32 ใช้กี่ไบต์ตามลำดับ?
 ``` c
float ใช้ 4 ไบต์ และ double ใช้ 8 ไบต์
```

- นักศึกษาสังเกตเห็นความแตกต่างของความแม่นยำระหว่าง float และ double อย่างไร? สถานการณ์ใดที่คุณควรเลือกใช้ double แทน float?
``` c
double แม่นยำกว่า เพราะ เห็นทศนิยมได้ถึง 15 ตำแหน่ง ส่วน float เห็นได้ 8 ตำแหน่ง, ใช้ double เมื่อเขียนโปรแกรมที่ต้องการความแม่นยำสูง เช่น การคำนวณวิศวกรรม
```
...
``` c
char ใช้ 1 ไบต์ และ แต่ละอักขระมีค่าตัวเลขจะจับคู่กับ ASCII ที่สัมพันธ์กัน
```
...
``` c
bool ใช้ 1 ไบต์ และ True = 1 และ False = 0
```
...
```c
long มีขอบเขตเท่ากับ int , เก็บค่าจำนวนเต็มบวกที่ใหญ่ที่สุด ให้ใช้ unsigned long long
```
...
``` c
byte ใช้ 1 ไบต์ , เมื่อเกิน 255 จะวนกลับไปเริ่มที่ 0
```
...
``` c
เพราะ ถ้าหารกับ int จะได้ผลลัพธ์เป็นจำนวนเต็มโดยเศษทศนิยมจะถูกตัดทิ้ง
```
...
``` c
-ต้องควบคุมชนิดข้อมูล

-ลดความแม่นยำ

-ป้องกันผลลัพธ์ที่ผิดพลาด
```
