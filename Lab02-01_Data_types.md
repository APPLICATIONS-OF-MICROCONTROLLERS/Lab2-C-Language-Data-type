...
ตอบ ตรงตามหลักคณิตศาสตร์ เพราะ ถ้าเกินค่านี้จะเกิด overflow ซึ่งทำให้ค่าที่แสดง ไม่ตรงกับที่ตั้งใจ 


2.3  สังเกตผลจากการรันโคิดในส่วน 2.3 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด<br>
ตอบ ไม่ตรงตามคณิตศาสตร์ทั่วไป แต่ ตรงตามหลักการคณิตศาสตร์ที่ใช้ในคอมพิวเตอร์ เพราะมีการจำกัดจำนวนบิตของตัวแปร int


2.4  สังเกตผลจากการรันโคิดในส่วน 2.4 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด<br>
ตอบ ตรงตามหลักการคณิตศาสตร์ เพราะ -2147483648 คือค่าต่ำสุดของ int (32-bit signed) และอยู่ในช่วงที่ถูกต้อง


2.5  สังเกตผลจากการรันโคิดในส่วน 2.5 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด<br>
ตอบ ไม่ตรงตามคณิตศาสตร์ทั่วไป เพราะ -2147483648 - 1 ต่ำกว่าขอบเขตล่างของ int → ค่าจะ วนกลับ (wrap around) ไปยังค่าบวกสูงสุด 2147483647
