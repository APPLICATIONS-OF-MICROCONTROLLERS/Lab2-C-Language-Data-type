...
- ตรง เพราะ ค่าปกติ ไม่มีการเกิด Overflow / Underflow

2.2  สังเกตผลจากการรันโคิดในส่วน 2.2 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด
- ตรง เพราะ กำหนด myInteger = 2147483647; // ค่าสูงสุด  และพอกดแสดงผลแล้วค่าตัวเลขไม่มีการบวกลบ

2.3  สังเกตผลจากการรันโคิดในส่วน 2.3 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด
- ไม่ตรง เพราะ Serial.print("myInteger = 2147483647 + 1 ผลลัพธ์: "); +1 จึงทำให้ผลลัพธ์เกิด overflow

2.4  สังเกตผลจากการรันโคิดในส่วน 2.4 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด
- ตรง เพราะ Serial.print("myInteger = -2147483648 ผลลัพธ์: "); เป็นค่าต่ำสุดของ int (ประมาณ -2,147,483,648 สำหรับ 32-bit int)

2.5  สังเกตผลจากการรันโคิดในส่วน 2.5 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด
- ไม่ตรง เพราะ เกิดค่าunderflow ทำให้ค่ากลับไปเป็นค่ามากสุด
...
- double มีความแม่นยำสูงกว่า float เพราะแสดงตัวเลขทศนิยมที่แม่นกว่า และเก็บได้เยอะกว่า

3.2 สถานการณ์ใดที่คุณควรเลือกใช้ double แทน float?
-1. ต้องการความแม่นยำ
2.ประมวลพิกัด เวลา ความเร็ว 
...
- unsigned long long  เป็นชนิดข้อมูลจำนวนเต็มบวกที่ใหญ่ที่สุดบน ESP32 มีขนาด 64 บิต
...
- เมื่อ myByte ถูกกำหนดให้เป็น 256 ผลลัพธ์ที่ได้คืออะไร และเพราะเหตุใด?
  - ผลลัพธ์ = 0 เพราะ เก็บค่าได้ตั้งแต่ 0 ถึง 255 เท่านั้น myByte = 256	เกินขอบเขตของ byte
