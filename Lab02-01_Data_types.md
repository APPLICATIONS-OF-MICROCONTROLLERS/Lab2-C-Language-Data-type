...
ใช่บน ESP32 long มีขอบเขตเท่ากับ int เพราะทั้ง int และ long บน ESP32 เป็น ชนิดข้อมูล 32-bit signed integer
...
ผลลัพธ์ที่ได้คือ 0
เพราะ ชนิดข้อมูล byte มีขนาด 8 บิต (0–255) และค่า 256 จะเกิด overflow ทำให้ วนกลับไปเริ่มที่ 0
