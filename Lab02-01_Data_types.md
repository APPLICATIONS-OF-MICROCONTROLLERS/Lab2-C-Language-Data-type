...
ตอบ ตรงตามหลักทางคณิตศาสตร์ เพราะ myInteger ถูกกำหนดถูกกำหนดค่าเป็น 100 และไม่มีการคำนวณใดๆ

2.2  สังเกตผลจากการรันโคิดในส่วน 2.2 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด

ตอบ ตรงตามหลักคณิตศาสตร์ เพราะ ค่าที่กำหนดค่าที่กำหนดคือ 2147483647 เป็นค่าสูงสุดและผลออกมาเป็นค่าสูงสุดคือ 2147483647

2.3  สังเกตผลจากการรันโคิดในส่วน 2.3 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด

ตอบ ไม่ตรงตามหลักทางคณิตศาสตร์ เพราะค่าเกินขอบเขตสูงสุด จึงทำให้เกิดค่า Integer Overflow ทำทำให้ผลวนกลับไปยังค่าต่ำสุด

2.4  สังเกตผลจากการรันโคิดในส่วน 2.4 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด

ตอบ ตรงตามหลักการทางคณิตศาสตร์ เพราะ -2147483648 เป็นค่าต่ำสุด ระบบสามารถเก็บได้พอดี

2.5  สังเกตผลจากการรันโคิดในส่วน 2.5 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด

ตอบ ไม่ตรงตามหลักคณิตศาสตร์ เพราะ ค่าเกินขอบเขตและ Integer Umderflow ทำให้ค่าผลลัพธ์กลับยังค่าที่มากที่สุดคือ 2147483647
...
ตอบ float แสดงค่าทศนิยม 8 ตำแหน่ง แต่ double แสดงค่าทศนิยม 15 ตำแหน่งและ double ให้ความแม่นยำมากกว่า

3.2 สถานการณ์ใดที่คุณควรเลือกใช้ double แทน float?

ตอบ สถานการณ์ที่ต้องการค่า Pi ที่แม่นยำมากกว่า
...
ตอบ ค่าตัวเลข ASCII value ใช้เป็นรหัสตัวเลขแทนสัญลักษณ์อักขระได้
...
ตอบ ตารางแมป เพื่อแปลงค่า ระหว่างตัวอักษรและรหัสอื่นๆได้แต่ต้องทำ ระหว่างตัวอักษรและรหัสอื่นๆแต่ต้องทำในบริบทที่ควบคุมเองได้
...
ตอบ ผลลัพธ์คือ 0 ค่าเกินขอบเขต
