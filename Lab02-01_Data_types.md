...
ตอบ doudleมีความแม่นยำมากกว่าfloat เพราะdoudleแสดงค่าทศนิยมได้มากกว่า
3.2 สถานการณ์ใดที่คุณควรเลือกใช้ double แทน float?
ตอบ ใช้dobleเมื่อต้องการคำนวณที่ต้องการความแม่นยำสูง
...
ตอบ trueจะถูกแทนด้วยเลข1 falseจะถูกแทนด้วยเลข0
...
ตอบ intและlong32-bit มีขอบเขตเหมือนกัน
...
ตอบ myByte = 256 ผลลัพธ์=0 เพราะbyteเก็บได้แค่ 0-255 และเกิด overflow 
