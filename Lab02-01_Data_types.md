...
ตอบ  ตรงตามหลักการทางคณิตศาสตร์ เพราะการกำหนดค่าปกติให้กับตัวแปร int ที่ยังอยู่ในช่วงที่รองรับได้ ค่า 100 อยู่ในช่วงที่ int รองรับ

2.2  สังเกตผลจากการรันโคิดในส่วน 2.2 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด

ตอบ ตรงตามหลักการทางคณิตศาสตร์ เพราะ 2147483647 คือค่าสูงสุดของ int

2.3  สังเกตผลจากการรันโคิดในส่วน 2.3 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด

ตอบ ไม่ตรงตามหลักการทางคณิตศาสตร์ เนื่องจากในทางคณิตศาสตร์ผลควรเป็น 2147483648

2.4  สังเกตผลจากการรันโคิดในส่วน 2.4 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด

ตอบ ตรงตามหลักการทางคณิตศาสตร์ เพราะ -2147483648 คือค่าต่ำสุดที่ int รองรับ

2.5  สังเกตผลจากการรันโคิดในส่วน 2.5 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด

ตอบ ไม่ตรงตามหลักการทางคณิตศาสตร์ เพราะผลควรเป็น -2147483649
...
ตอบ ตัวแปร Float จะแสดงค่าทศนิยม 6-7ตำแหน่ง ตำแหน่งที่ 8 ค่าจะไม่แม่นยำ 
    ตัวแปร double จะแสดงค่าได้ถึง 15-16ตำแหน่ง 

3.2 สถานการณ์ใดที่คุณควรเลือกใช้ double แทน float?

ตอบ ใช้ double ก็ต่อเมื่อต้องการความแม่นยำ เข่น การคำนวณคณิตศาสตร์ ฟิสิกส์ 
...
ตอบ true จะถูกแทนด้วย เลข 1
    false จะถูกแทนด้วย เลข 0
