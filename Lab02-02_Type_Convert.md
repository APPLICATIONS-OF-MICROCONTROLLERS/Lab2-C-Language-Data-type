...
``` c
เพราะหารกับ float หรือ double จะได้ผลลัพธ์เป็นทศนิยม แต่ถ้าหารกับ int จะตัดทศนิยมทิ้ง เหลือแค่จำนวนเต็ม
```
...
``` c
ต้องการชนิดข้อมูลเพื่อควบคุมผลลัพธ์ให้ถูกต้อง เช่น ให้ได้ทศนิยม ตัดทศนิยม 
```
