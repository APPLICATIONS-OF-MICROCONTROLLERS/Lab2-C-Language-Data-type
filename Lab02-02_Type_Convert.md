...
ตอบ เพราะเมื่อใช้ 10 / 3.0 ซึ่งตัวหารเป็นชนิด float หรือ double ค่าตัวแปร int 10 จะถูกแปลงอัตโนมัติให้เป็น float หรือ double ด้วย จากนั้นจึงทำการหารแบบทศนิยม ทำให้ผลลัพธ์มีทศนิยม
แต่เมื่อแปลงตัวหารให้เป็น int เช่น int 3.0 ผลลัพธ์จะเป็นการหารแบบจำนวนเต็ม
...
ตอบ สถานการณ์ที่จำเป็นต้องทำ Type Casting (การแปลงชนิดข้อมูล)
