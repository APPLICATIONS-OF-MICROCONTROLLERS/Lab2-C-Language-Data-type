...
ตอบ เมื่อ int หารกับ float หรือ double จะมีการ ยกระดับชนิดข้อมูล (Type Promotion) ให้เป็นชนิดที่มีความแม่นยำสูงกว่า (เช่น float หรือ double) ส่งผลให้ได้ ผลลัพธ์เป็นทศนิยม
...
ตอบ เมื่อชนิดข้อมูลไม่ตรงกันในการใช้งาน ควรใช้ Type Casting เพื่อให้ผลลัพธ์ถูกต้อง ป้องกันข้อผิดพลาดในการคำนวณ
