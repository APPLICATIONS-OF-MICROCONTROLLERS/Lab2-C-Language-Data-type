...
1.1  ทำไม 10 / 3.0 (เมื่อตัวหารเป็น float หรือ double) ถึงได้ผลลัพธ์เป็นทศนิยม แต่เมื่อตัวหารถูกแปลงเป็น int แล้วผลลัพธ์เป็นจำนวนเต็ม?
    ...
    ถ้าฝั่งใดฝั่งหนึ่งเป็นทศนิยม (float/double) ผลลัพธ์จะเป็นทศนิยม

    ถ้าทั้งสองฝั่งเป็นจำนวนเต็ม (int) ผลลัพธ์ก็จะเป็นจำนวนเต็ม (เศษทศนิยมจะถูกตัดทิ้ง)
...
- ในการเขียนโปรแกรม ต้องทำ Type Casting ในสถานการณ์ใดบ้าง
      ...
      เมื่อคำนวณหรือเปรียบเทียบค่าต่างชนิด,เมื่อเก็บค่าลงในตัวแปรที่ชนิดข้อมูลต่างกัน,เมื่อใช้ข้อมูลที่เป็นรหัส ASCIIมเมื่อรับข้อมูลจากเซ็นเซอร์/ฟังก์ชันที่ return type ต่างจากที่ต้องการใช้,เมื่อใช้ร่วมกับไลบรารี หรือ Hardware ที่ต้องระบุชนิดข้อมูลเฉพาะ,ลดขนาดข้อมูลเพื่อประหยัดหน่วยความจำ
