...
Serialทำความเข้าใจว่าการคำนวณระหว่างชนิดข้อมูลต่างกันมีผลลัพธ์อย่างไร
...
เพราะชนิดข้อมูลของตัวถูกหาร (numerator) และตัวหาร (denominator) มีผลต่อชนิดของผลลัพธ์ (result)
...
1. เมื่อหารจำนวนเต็มแล้วต้องการผลลัพธ์แบบทศนิยม
2.เมื่อแปลงค่าทศนิยมเป็นจำนวนเต็ม
3.มื่อแปลงตัวอักษร (char) เป็นเลข ASCII หรือกลับกัน
4.เมื่อทำงานกับชนิดข้อมูลต่างกันในการคำนวณ
5เมื่อส่งค่าเข้าไปในฟังก์ชันที่ต้องการชนิดข้อมูลเฉพาะ
