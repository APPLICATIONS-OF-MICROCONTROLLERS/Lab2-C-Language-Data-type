...
- นักศึกษาสังเกตเห็นความแตกต่างของความแม่นยำระหว่าง float และ double อย่างไร? สถานการณ์ใดที่คุณควรเลือกใช้ double แทน float?
  - float และ double ให้ ค่าคล้ายกันมาก และไม่แม่นยำตามที่ double ควรจะเป็น
...
- char ใช้กี่ไบต์? ค่าตัวเลข (ASCII value) มีความสัมพันธ์กับอักขระอย่างไร?
  -char ใช้ 1 ไบต์ ตัวแปร char เก็บค่าเป็นตัวเลขจำนวนเต็มตั้งแต่ 0 ถึง 255 
...
- บน ESP32, long มีขอบเขตเท่ากับ int หรือไม่? ชนิดข้อมูลใดที่คุณจะใช้หากต้องการเก็บค่าจำนวนเต็มบวกที่ใหญ่ที่สุด?
  - มีขนาดและขอบเขตเท่ากัน ใช้ชนิดข้อมูล unsigned long long
...
-byte ใช้พื้นที่ 1 ไบต์ ผลลัพธ์ที่ได้คือ 0 เพราะ byte เก็บค่าได้ในช่วง 0 ถึง 255 เท่านั้น
...
-int / float หรือ int / double	ผลลัพธ์คือ ทศนิยม(จำนวนจริง)	เพราะ ตัวหารเป็น floating-point, int ถูกแปลงเป็น float/double
 int / (int)	 	ผลลัพธ์คือ จำนวนเต็ม (ไม่มีทศนิยม)	เพราะ หารแบบจำนวนเต็ม ทศนิยมถูกตัดทิ้ง
...
- 1 เมื่อคำนวณระหว่างชนิดข้อมูลต่างกัน
  2 แปลงข้อมูลเพื่อใช้ฟังก์ชันที่รับเฉพาะชนิดข้อมูลหนึ่ง
  3 แก้ไขปัญหาการแปลงอัตโนมัติที่อาจทำให้ผลลัพธ์ผิด
