...
ตอบ เกิดค่า overflow ค่าจะเปลี่ยนเป็นค่าต่ำสุด
...
ตอบ 1 bytes Z พิมพ์ใหญ่ อยู่ในรูป ASCII:90 แต่ 122 จะได้ z พิมพ์เล็ก
...
ตอบ long 4 bytes, long long 8bytes, unsigned int 4 bytes, unsigned long 4 bytes, unsigned long long 8 bytes
...
ตอบ 1 bytes ผลลัพธ์คือ 0 เพราะเป็นค่าเกินขอบเขต
...
ตอบ เพราะ int หาร float or double จะได้ float or double แต่ถ้า int หาร int เลขทศนิยมจะถูกตัดออก
